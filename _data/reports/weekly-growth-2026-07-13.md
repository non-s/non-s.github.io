...
Generated: 2026-07-13T06:39:06.482216+00:00

## Winners

- Category `arctic`: score 18.0 across 1 rows
- Category `space`: score 13.734 across 1 rows
- Category `farm`: score 6.6 across 3 rows
- Category `insects`: score 0.0 across 2 rows
...
- `8jYCCf-lSvc`: Cows remember faces across the herd (44.0%)
- `FauBvdeAeU8`: Birds use ultraviolet vision before they change (40.0%)
- `GfY4m0L2rRA`: The moon keeps one face turned toward Earth (30.52%)
