...
Generated: 2026-07-07T07:02:43.056782+00:00

## Winners

- Category `wildlife`: score 0.0 across 1 rows
- Category `space`: score 0.0 across 1 rows
- Category `chemistry`: score 0.0 across 1 rows
- Category `rivers`: score 0.0 across 1 rows
- Category `farm`: score 0.0 across 4 rows
...
- No low-retention openings in normalized rows.
