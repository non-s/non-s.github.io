...
ROBOTIC_TITLE_PATTERNS: tuple[tuple[str, str], ...] = (
    ...
    ("generic_body_posture_template", r"\b(?:rely on body posture|recognize faces through body posture|signal the next move with body posture|through body cue)\b"),
    ("generic_detail_template", r"\b(?:signal the next move with detail|watch the detail when|the detail that explains)\b"),
    ...
    ("generic_signal_through_body_cue", r"\brecognize signals through (?:body cue|body posture|ear position|eye contact|face shape|feeding cue|fin movement|first movement|flipper movement|hand movement|head movement|tail position|wing movement|wing position|beak movement|ear|ears|eye|eyes|face|faces|feet|fin|fins|flipper|flippers|hand|hands|head|hoof|hooves|leg|legs|nose|paw|paws|tail|wing|wings)\b"),
    ("generic_rely_to_signal_cue", r"\brely on (?:the )?(?:body cue|body posture|ear position|eye contact|face shape|feeding cue|fin movement|first movement|flipper movement|hand movement|head movement|tail position|wing movement|wing position|beak movement|ear|ears|eye|eyes|face|faces|feet|fin|fins|flipper|flippers|hand|hands|head|hoof|hooves|leg|legs|nose|paw|paws|tail|wing|wings) to signal\b"),
    ("generic_next_move_cue", r"\bsignal the next move with (?:body cue|body posture|ear position|eye contact|face shape|feeding cue|fin movement|first movement|flipper movement|hand movement|head movement|tail position|wing movement|wing position|beak movement|ear|ears|eye|eyes|face|faces|feet|fin|fins|flipper|flippers|hand|hands|head|hoof|hooves|leg|legs|nose|paw|paws|tail|wing|wings)\b"),
    ...
    ("generic_first_move_title", r"\b(?:read the moment from one first move|react differently when the first move appears|rely on (?:the )?first movement to [a-z]+)\b"),
