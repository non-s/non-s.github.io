...
def _build_metadata_prompt(hook: str, scene: str, duration: int, kind: str, emoji: str, lang: str = "en") -> str:
    ...
    if lang == "pt":
        return (
            ...
            f"Regras:\n"
            f"- Titulo fofo e acolhedor, SEM clickbait, SEM palavras sensacionalistas, "
            f"max {target_len} caracteres; cite o animal visivel e jazz/musica ou o momento real.\n"
            ...
            f"nao prometa sono, calma, saude ou mudanca de comportamento.\n"
    ...
    if lang == "es":
        return (
            ...
            f"Reglas:\n"
            f"- Titulo tierno y acogedor, SIN clickbait, SIN palabras sensacionalistas, "
            f"max {target_len} caracteres; nombra el animal visible y jazz/musica o el momento real.\n"
            ...
            f"no prometas sueno, calma, salud ni cambios de comportamiento.\n"
    ...
    return (
        ...
        f"Name the visible species and jazz/music or the real moment.\n"
        ...
        f"- {desc_lines}-line description, light and cute tone, with the matching animal and music emoji. "
        f"Never promise sleep, calm, health, or a behavior change.\n"
...
def _build_batch_metadata_prompt(
    ...
    return (
        ...
        f"- title_alt: a DIFFERENT title (different angle/keywords) for A/B testing, "
        f"max {target_len} characters, with the same species rule.\n"
        f"- description: 3-4 lines, light and cute, with the matching animal and music emoji. "
        f"Never promise sleep, calm, health, or behavior change.\n"
