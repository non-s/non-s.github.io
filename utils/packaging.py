...
NATURE_SERIES_BY_CATEGORY = {
    ...
    "space": "Space Signals",
    "physics": "Physics Brief",
    "chemistry": "Chemistry Brief",
    "microscopy": "Micro World",
}
ANIMAL_SERIES_NAMES = {
    "animal intelligence",
    "animal memory",
...
NATURE_CATEGORY_SIGNALS = (
    ...
    ("conservation", ("conservation", "reforestation", "restoration", "protected forest", "tree planting")),
    ("space", ("space", "moon", "mars", "sun", "solar", "galaxy", "rocket", "satellite", "telescope")),
    ("physics", ("magnet", "magnets", "magnetic", "physics")),
    ("chemistry", ("chemistry", "chemical", "reaction", "reactions", "crystal", "crystals", "lab")),
    ("microscopy", ("microscope", "microscopy", "cell", "cells", "bacteria", "microbe", "microbes")),
