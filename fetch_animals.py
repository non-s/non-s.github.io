...
_AI_PROMPT_TEMPLATE = (
    ...
    "RETENTION FORMULA (THE ZEIGARNIK EFFECT): 0-3s = Open a massive curiosity loop or mystery that is impossible to ignore; "
    "3-10s = Build tension and context without giving away the answer; "
    "10-14s = Deliver the mind-blowing answer at the VERY LAST SECOND, followed by a "
