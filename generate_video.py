...
# ── (removido) Tradução PT-BR ──────────────────────────────────
# A versão PT-BR do roundup foi desligada — o canal publica somente
# o vídeo principal em inglês + os Shorts. Removidos: _translate_script_pt
# e create_pt_video. Para religar, restaure ambos a partir do histórico
# e reintroduza o bloco PT em main() depois de build_metadata().
