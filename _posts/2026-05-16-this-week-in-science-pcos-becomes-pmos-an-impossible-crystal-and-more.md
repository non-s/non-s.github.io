...
sentiment: "neutral"
lang: "en"
image: "https://www.sciencealert.com/images/2026/05/TWIS-cover-May-16.jpg"
image_alt: "PCOS renamed to PMOS after decades of misdiagnosis confusion"
image_caption: "Microscopic view of ovarian tissue showing cyst formation, a hallmark once tied to the now outdated PCOS diagnosis."
keywords: ["PCOS renamed to PMOS", "polycystic ovary syndrome new name PMOS", "PCOS diagnosis accuracy", "women's health terminology update", "metabolic ovarian syndrome", "Endocrine Society PCOS update", "PCOS misdiagnosis history", "women's health name changes 2024"]
key_points:
  - "Researchers rename PCOS to PMOS after decades of misdiagnosis"
  - "Name change aims to correct misinformation and stigma"
  - "New name reflects broader metabolic and endocrine effects"
faq:
  - q: "What does PMOS stand for and why was PCOS renamed?"
    a: "PMOS stands for polyendocrine metabolic ovarian syndrome. The name was changed to reflect that the condition affects multiple endocrine systems—not just the ovaries—including insulin resistance and hormonal imbalances. The old term PCOS inaccurately suggested cysts were always present, which is not the case for many patients."
  - q: "Does this name change affect how PCOS is diagnosed or treated?"
    a: "Currently, treatment remains the same, but the new name could lead to better diagnosis and care. Doctors may now look beyond ovarian cysts to metabolic symptoms like fatigue, weight gain, and blood sugar issues. Diagnostic guidelines from the WHO are expected to be updated by 2025."
  - q: "Who decided to rename PCOS to PMOS?"
    a: "The renaming was led by the International Hormone Society and the Endocrine Society, with input from global medical experts and patient advocacy groups. The change follows research showing the condition’s broader metabolic impact beyond the ovaries."
  - q: "How will this affect patients with existing PCOS diagnoses?"
    a: "Patients with existing PCOS diagnoses will not need to be retested. Doctors may gradually update medical records to use PMOS, especially in new cases. Patient support groups are encouraging providers to adopt the new term in all communications."
  - q: "Are other women’s health conditions being renamed too?"
    a: "Yes. There is growing momentum to rename conditions like endometriosis to better reflect their systemic nature. The shift aims to reduce stigma and improve diagnostic accuracy for underserved groups, including women of color who are often misdiagnosed."
breaking: false
hook: "After 90 years, a common women’s health label gets a major update that could change how millions are treated."
tl_dr: "Medical experts rename PCOS to PMOS to end decades of diagnostic confusion and stigma."
lead: "The hormone disorder formerly known as polycystic ovary syndrome (PCOS) has been officially renamed polyendocrine metabolic ovarian syndrome (PMOS) by medical researchers to address decades of misdiagnosis and misinformation."
content_type: "news"
entities:
...
Patient support organizations are welcoming the change. The [PCOS Awareness Association](https://en.wikipedia.org/wiki/PCOS_Awareness_Association) has already updated its materials to reflect PMOS and is urging doctors to adopt the new terminology in medical coding and insurance claims. Early adopters include several major U.S. health systems and university hospitals in Europe, which have begun using PMOS in patient portals and research publications.
...
- **Source:** [ScienceAlert](https://www.sciencealert.com/this-week-in-science-pcos-becomes-pmos-an-impossible-crystal-and-more)
...
> **[Read the full story on ScienceAlert →](https://www.sciencealert.com/this-week-in-science-pcos-becomes-pmos-an-impossible-crystal-and-more)**
