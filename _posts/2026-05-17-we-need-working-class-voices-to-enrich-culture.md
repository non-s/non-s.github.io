---
layout: post
title: "Why working-class voices matter for UK culture and media"
date: 2026-05-17 09:15:37 +0000
categories: [business]
tags: [bbc, business, economy, northumberland, kate-pasola, working-class-voices, uk-media-representation, class-barriers-in-journalism, working-class-culture, diversity-in-arts, working-class-accents-in-media, why-working-class-stories-matter, class-bias-in-media-hiring, how-to-fix-media-diversity, working-class-voices-in-theatre]
author: "GlobalBR News"
description: "A Northumberland journalist says UK culture loses out when working-class voices get left out. Here’s why that needs to change now."
source_url: "https://www.bbc.com/news/articles/c80mvl9p40vo?at_medium=RSS&at_campaign=rss"
source_name: "BBC News"
sentiment: "neutral"
lang: "en"
image: "/assets/images/posts/we-need-working-class-voices-to-enrich-culture.webp"
image_alt: "Why working-class voices matter for UK culture and media"
image_caption: "A close-up portrait of journalist Kate Pasola speaking at a microphone, representing working-class voices in media."
keywords: ["working-class voices", "UK media representation", "class barriers in journalism", "working-class culture", "diversity in arts", "working-class accents in media", "why working-class stories matter", "class bias in media hiring"]
key_points:
  - "Kate Pasola says UK culture ignores working-class voices daily"
  - "She argues this gap weakens media and arts, not just politics"
  - "Pasola wants action, not just talk, to fix the imbalance"
faq:
  - q: "What specific barriers keep working-class voices out of UK media?"
    a: "Research shows top UK journalists are 39% privately educated, despite only 7% of the general population attending private schools. Unpaid internships, lack of connections, and unconscious bias in hiring all play a role. Many working-class candidates can’t afford to work for free or lack the networks to break into elite spaces."
  - q: "How does this affect the stories we see in media and arts?"
    a: "Working-class issues often get reduced to stereotypes or ignored entirely. Benefits debates focus on ‘scroungers’ rather than real struggles, while theatre and literature skew toward upper-class perspectives. Shows like Derry Girls prove that when working-class voices are centered, stories become more authentic and engaging."
  - q: "What’s one simple change that could help?"
    a: "Scrap unpaid internships in media and arts. Offer paid entry-level roles and actively recruit from state schools. This would immediately open doors for people who can’t afford to work for free, leveling the playing field."
  - q: "Why do working-class accents get mocked in media?"
    a: "There’s a deep-seated bias that associates certain accents with lower intelligence or lack of sophistication. This isn’t just about humor—it’s about power. Media shapes what we consider ‘normal,’ and when working-class accents are sidelined, it reinforces class divides."
  - q: "Can working-class voices really make a difference in high culture?"
    a: "Absolutely. Look at shows like This Country or Derry Girls. They didn’t tone down their working-class settings or humor—they trusted audiences to engage with authentic stories. The result? Hits that resonate because they feel real, not manufactured."
breaking: false
hook: "What if the best stories in UK media were being ignored because of where people grew up?"
tl_dr: "UK journalist Kate Pasola says working-class voices are missing in media and culture—here’s why that hurts everyone."
lead: "Northumberland journalist Kate Pasola says UK media and arts miss out when working-class voices get shut out. She’s calling for real change, not just words."
...
Some people assume working-class representation is just a political issue. But Pasola says it’s about creativity, too. She uses the success of shows like [Derry Girls](https://en.wikipedia.org/wiki/Derry_Girls) as proof. The hit series, set in 1990s Derry, is packed with working-class voices and working-class humor. It’s funny, sharp, and deeply human—because it’s real. "Derry Girls worked because it wasn’t trying to be ‘working-class’ for the sake of it," Pasola says. "It just told the story it wanted to tell, and the class of the characters was part of what made it authentic." That’s the difference. When working-class voices aren’t just included but centered, culture gets richer. Jokes land better. Characters feel real. News feels relevant.

## What needs to change
Pasola isn’t just airing grievances. She’s calling for concrete steps. First, she wants journalism schools and media companies to actively recruit from non-traditional backgrounds. That means targeting students at state schools, offering paid internships, and scrapping unpaid work experience that shuts out people who can’t afford to work for free. Second, she wants funders and producers to stop assuming that working-class stories need to be ‘explained’ to audiences. She points to the success of [This Country](https://en.wikipedia.org/wiki/This_Country), the BBC sitcom about council estate life. The show didn’t dumb down its humor or its setting. It trusted audiences to get it. Third, she’s pushing for more working-class voices in decision-making roles—not just as consultants, but as editors, producers, and artistic directors. "You can’t fix a system by adding a few token voices at the bottom," she says. "The people in charge need to look like the people they’re supposed to represent."

## The cost of staying silent
Pasola isn’t naive. She knows change won’t happen overnight. But she warns that the cost of doing nothing is high. Culture isn’t just entertainment. It’s how we see ourselves, how we laugh, how we argue, and how we learn. When it only reflects one slice of society, everyone loses. She points to the backlash against working-class accents in media—like the recent controversy over [Gary Lineker](https://en.wikipedia.org/wiki/Gary_Lineker)’s accent being mocked in a TV interview. "It’s not just about Gary Lineker," she says. "It’s about the idea that certain ways of speaking are acceptable, and others aren’t. That’s a cultural rot. And it’s spreading."
...
- **Source:** [BBC News](https://www.bbc.com/news/articles/c80mvl9p40vo?at_medium=RSS&at_campaign=rss)
...
> **[Read the full story on BBC News →](https://www.bbc.com/news/articles/c80mvl9p40vo?at_medium=RSS&at_campaign=rss)**
