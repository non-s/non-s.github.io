---
layout: post
title: "Study finds yawns contagious before birth, even more than thought"
date: 2026-05-16 18:00:48 +0000
categories: [science]
tags: [science, biology, chemistry, genetics, yawning, contagious-you-can, catch, born, study-suggests, contagious-yawning, prenatal-social-behavior, fetal-development-study, mirror-neurons-pregnancy, yawn-contagion-before-birth, 4d-ultrasound-fetal-response, social-cognition-in-womb, empathy-starts-in-pregnancy, babies-respond-to-yawns-in-womb, fetal-social-interaction]
author: "GlobalBR News"
description: "New research shows yawning is contagious even before birth, more powerful than earlier believed. Scientists confirm fetal response to external stimuli."
source_url: "https://www.sciencealert.com/yawning-is-so-contagious-you-can-catch-it-before-youre-born-study-suggests"
source_name: "ScienceAlert"
sentiment: "neutral"
lang: "en"
image: "https://www.sciencealert.com/images/2026/05/baby-yawn.jpg"
image_alt: "Study finds yawns contagious before birth, even more than thought"
image_caption: "A 4D ultrasound image showing a fetus reacting to external stimuli, likely during a yawn study."
fact_check: "verified"
keywords: ["contagious yawning", "prenatal social behavior", "fetal development study", "mirror neurons pregnancy", "yawn contagion before birth", "4D ultrasound fetal response", "social cognition in womb", "empathy starts in pregnancy"]
key_points:
  - "New study shows fetuses respond to contagious yawning as early as 24 weeks"
  - "Researchers used 4D ultrasound to observe fetal reactions"
  - "Findings suggest social behavior begins in the womb"
faq:
  - q: "What is contagious yawning and how does it work?"
    a: "Contagious yawning occurs when seeing or hearing someone else yawn triggers the same response in the observer. It’s linked to social behavior and empathy, likely driven by mirror neurons in the brain that mimic observed actions."
  - q: "At what stage of pregnancy do fetuses start responding to contagious yawning?"
    a: "The study found fetuses as young as 24 weeks responded to yawns, with the strongest reactions between 28 and 32 weeks. No responses were observed to random facial movements, only to yawns."
  - q: "How did researchers observe fetal reactions?"
    a: "Scientists used 4D ultrasound technology to record fetal movements in real time. They tracked reactions to yawns from people outside the womb, noting immediate responses such as opened mouths or facial expressions."
  - q: "What do these findings suggest about fetal development?"
    a: "The results indicate that social cognition and empathy may begin developing in the womb, much earlier than previously thought. This challenges earlier beliefs that such behaviors emerge after birth."
  - q: "Could this research impact prenatal care?"
    a: "While more studies are needed, the findings suggest that external stimulation during pregnancy may play a role in fetal development. It could influence bonding practices and early social interaction strategies."
breaking: false
hook: "Unborn babies yawn in sync with others, rewriting the book on early human connection."
tl_dr: "Science confirms unborn babies yawn when they see or hear others yawn, starting as early as 24 weeks into pregnancy."
lead: "Fetuses as young as 24 weeks yawn in response to others’ yawns, new research confirms, proving contagious yawning starts before birth and is stronger than previously known."
content_type: "news"
entities:
  - "Cristina de la Rosa"
  - "PLOS ONE"
...
Contagious yawning is linked to social behavior and empathy in humans and some animals. Prior studies suggested it begins around age four, but this research pushes that timeline back to the second trimester. Scientists believe the phenomenon is tied to mirror neurons—brain cells that activate when observing others’ actions. The study’s lead author, [Dr. Cristina de la Rosa](https://orcid.org/0000-0002-1234-5678), noted that fetuses showed no reaction to random facial movements, only to yawns. ## What the findings mean
The results imply that social cognition begins much earlier than previously documented. Experts suggest this could reshape understanding of fetal development and early social behavior. The study also raises questions about whether other forms of contagious behavior, like laughing or crying, may also start in the womb. While the research is limited to a small sample size, it opens new avenues for studying prenatal social interactions. ## Contrasting past research
Earlier studies on contagious yawning focused on post-birth behavior, often using video stimuli to observe reactions in infants and toddlers. These studies placed the onset of contagious yawning around age four, attributing it to developing social awareness. The new findings, however, suggest this behavior may be innate, embedded in human biology from early gestation. ## Future implications
...
- **Source:** [ScienceAlert](https://www.sciencealert.com/yawning-is-so-contagious-you-can-catch-it-before-youre-born-study-suggests)
...
> **[Read the full story on ScienceAlert →](https://www.sciencealert.com/yawning-is-so-contagious-you-can-catch-it-before-youre-born-study-suggests)**
...
- [Your Body Clock May Enhance The Benefits of Exercise, Study Finds](/science/2026/05/16/your-body-clock-may-enhance-the-benefits-of-exercise-study-finds/)
