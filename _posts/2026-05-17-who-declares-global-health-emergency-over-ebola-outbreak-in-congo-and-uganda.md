---
layout: post
title: "WHO declares Ebola emergency as Congo and Uganda outbreaks surge"
date: 2026-05-17 08:39:08 +0000
categories: [world, politics]
tags: [france24, world-news, europe, politics, usa, democrats, ebola, congo, health-organization, sunday, democratic-republic, ebola-outbreak-congo-uganda, ebola-emergency-who, ebola-deaths-congo-uganda, ebola-vaccine-congo, ebola-spread-africa, ebola-global-health-emergency, who-declares-ebola-emergency-in-africa, ebola-outbreak-2023, ebola-cases-congo-uganda, ebola-containment-measures]
author: "GlobalBR News"
description: "WHO declares Ebola a global emergency after Congo and Uganda outbreaks kill 88 and infect 300+. Here’s what you need to know."
source_url: "https://www.france24.com/en/health/20260517-who-declares-global-health-emergency-over-ebola-outbreak-in-congo-and-uganda"
source_name: "France 24"
sentiment: "neutral"
lang: "en"
last_updated: "2026-05-17"
image: "https://s.france24.com/media/display/f748efae-51c3-11f1-b17c-005056a97e36/w:1024/p:16x9/AP26136413586187.jpg"
image_alt: "WHO declares Ebola emergency as Congo and Uganda outbreaks surge"
image_caption: "A health worker in protective gear administers an Ebola vaccine to a patient in eastern Democratic Republic of the Congo"
keywords: ["Ebola outbreak Congo Uganda", "Ebola emergency WHO", "Ebola deaths Congo Uganda", "Ebola vaccine Congo", "Ebola spread Africa", "Ebola global health emergency", "WHO declares Ebola emergency in Africa", "Ebola outbreak 2023"]
key_points:
  - "WHO declares Ebola outbreak a global health emergency"
  - "88 deaths confirmed in Congo and Uganda outbreaks"
  - "Over 300 suspected cases reported in the region"
faq:
  - q: "What triggered the WHO’s emergency declaration for Ebola?"
    a: "The WHO declared the emergency after Ebola outbreaks in Congo and Uganda caused 88 deaths and over 300 suspected cases, raising fears the virus could spread to neighboring countries. The declaration aims to mobilize global resources and coordinate a stronger response."
  - q: "How many people have been affected by the Ebola outbreaks?"
    a: "As of the latest reports, the outbreaks have killed 88 people and infected at least 300 others in Congo and Uganda. Four cases have been confirmed in Uganda, including one death, raising concerns about cross-border spread."
  - q: "Why is the Ebola outbreak in Congo and Uganda so dangerous?"
    a: "The outbreaks are dangerous because they’re happening in a region with weak healthcare systems, ongoing violence, and porous borders. The virus has already spread between Congo and Uganda, and health workers struggle to contain it due to mistrust and logistical challenges."
  - q: "What measures are being taken to stop Ebola from spreading?"
    a: "Teams are vaccinating high-risk groups, setting up isolation units, and screening travelers at borders. The U.S. CDC and WHO are also assisting with contact tracing and lab testing, but supplies and security remain major hurdles."
  - q: "Could this Ebola outbreak become a global crisis?"
    a: "There’s a real risk if the outbreaks aren’t controlled quickly. The WHO’s emergency declaration is meant to prevent that, but the virus could spread further if containment efforts fail. Neighboring countries are already on high alert."
featured: true
breaking: true
hook: "Ebola’s back—and this time, it’s spreading across borders."
tl_dr: "WHO declares Ebola a global emergency after Congo and Uganda outbreaks kill 88 and infect 300."
lead: "The World Health Organization [WHO](https://en.wikipedia.org/wiki/World_Health_Organization) declared a global health emergency on Sunday after Ebola outbreaks in the Democratic Republic of the Congo and Uganda killed 88 people and sickened over 300. The declaration warns that neighboring countries face serious risks if the virus spreads further."
...
The World Health Organization [WHO](https://en.wikipedia.org/wiki/World_Health_Organization) raised the alarm on Sunday, labeling the Ebola outbreaks in the Democratic Republic of the Congo [DRC](https://en.wikipedia.org/wiki/Democratic_Republic_of_the_Congo) and Uganda a ‘public health emergency of international concern.’ This is the fifth such declaration since 2009 and the second this year, following a separate outbreak in DRC that began in August 2022. The move signals a serious threat to global health security, as health officials scramble to contain the virus before it jumps borders.
...
- **Source:** [France 24](https://www.france24.com/en/health/20260517-who-declares-global-health-emergency-over-ebola-outbreak-in-congo-and-uganda)
...
> **[Read the full story on France 24 →](https://www.france24.com/en/health/20260517-who-declares-global-health-emergency-over-ebola-outbreak-in-congo-and-uganda)**
