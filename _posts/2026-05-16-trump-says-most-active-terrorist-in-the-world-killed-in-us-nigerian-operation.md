---
layout: post
title: "Trump says 'most active terrorist in the world' killed in US-Nigerian operation"
date: 2026-05-16 06:45:11 +0000
categories: [world]
tags: [euronews, europe, world-news, trump, nigerian, bilal, minuki, islamic-state, abu-bilal-al-minuki-death, isis-second-in-command-killed, us-niger-counterterrorism-operation, islamic-state-leadership-decapitation, isis-west-africa-province-leader-killed, niger-counterterrorism-strike, donald-trump-on-abu-bilal-al-minuki, sahel-isis-militant-killed]
author: "GlobalBR News"
description: "US-Niger military operation eliminates Abu-Bilal al-Minuki, Islamic State’s second-in-command, in a joint counterterrorism mission. Groundbreaking strike disrup"
source_url: "http://www.euronews.com/2026/05/16/trump-says-most-active-terrorist-in-the-world-killed-in-us-nigerian-operation"
source_name: "Euronews"
sentiment: "negative"
lang: "en"
image: "https://images.euronews.com/articles/stories/09/71/47/46/1200x675_cmsv2_8061d737-86b1-5d1a-9832-134be3ee6dc1-9714746.jpg"
image_alt: "Trump says 'most active terrorist in the world' killed in US-Nigerian operation"
image_caption: "A US soldier participates in a joint military exercise with Nigerien forces, highlighting the ongoing counterterrorism p"
keywords: ["Abu-Bilal al-Minuki death", "ISIS second-in-command killed", "US-Niger counterterrorism operation", "Islamic State leadership decapitation", "ISIS West Africa Province leader killed", "Niger counterterrorism strike", "Donald Trump on Abu-Bilal al-Minuki", "Sahel ISIS militant killed"]
key_points:
...
faq:
  - q: "Who was Abu-Bilal al-Minuki and what was his role in ISIS?"
    a: "Abu-Bilal al-Minuki, also known as Mahamat Saleh Al-Minuni, was the deputy leader of the Islamic State’s West Africa Province (ISWAP) and previously a high-ranking commander in Boko Haram. Appointed as ISIS’s global deputy leader in 2021, he played a key role in coordinating the group’s operations across Africa and beyond."
  - q: "How did the US and Niger locate and target Abu-Bilal al-Minuki?"
    a: "The operation was described as a 'meticulously planned and very complex' mission by the White House, suggesting it involved advanced intelligence gathering, surveillance, and coordination between US and Nigerien forces. Specific details about the operation, including the method of targeting, remain undisclosed due to security concerns."
  - q: "What is the significance of al-Minuki’s death for ISIS?"
    a: "Al-Minuki’s death is a major blow to ISIS’s leadership in Africa, where the group has been expanding its influence. As the global deputy leader, his elimination disrupts ISIS’s command structure and could temporarily weaken the group’s operational capacity in the region."
  - q: "How has ISIS responded to recent leadership losses in Africa?"
    a: "Despite recent losses, including the 2019 killing of ISIS leader Abu Bakr al-Baghdadi and the 2021 death of Abu Musab al-Barnawi, ISIS has shown resilience by regrouping and exploiting local grievances. The group’s decentralized structure allows it to absorb leadership losses, though frequent decapitations can disrupt its operations."
  - q: "What are the next steps for US counterterrorism efforts in Africa?"
    a: "The US will likely continue targeting high-value ISIS figures in collaboration with regional partners like Niger. However, experts emphasize that long-term success depends on addressing the root causes of instability, such as weak governance and local grievances, which ISIS exploits to expand its reach."
featured: true
breaking: true
hook: "A top ISIS leader is dead after a rare US-Niger operation—what’s next for the terror group?"
tl_dr: "US-Niger operation kills Islamic State’s top deputy Abu-Bilal al-Minuki in precision strike."
lead: "Abu-Bilal al-Minuki, the Islamic State group’s second-in-command globally, was killed in a joint US-Niger military operation, President Donald Trump announced on Wednesday."
content_type: "news"
entities:
  - "Abu-Bilal al-Minuki"
  - "Islamic State (ISIS)"
...
The operation underscores the ongoing collaboration between the US and African nations to dismantle ISIS affiliates operating across the Sahel region. [Niger](https://en.wikipedia.org/wiki/Niger), a key US partner in counterterrorism efforts, has hosted American military personnel and drone operations for years. The Pentagon confirmed the operation but provided no further operational details, citing the sensitivity of ongoing military actions. Local reports from Niger suggest the strike occurred in the Tillabéri region, an area known for ISIS-affiliated militant activity.

Al-Minuki, whose real name was identified as [Mahamat Saleh Al-Minuni](https://en.wikipedia.org/wiki/Abu_Bilal_al-Harith), rose through the ranks of ISIS after defecting from [Boko Haram](https://en.wikipedia.org/wiki/Boko_Haram), another extremist group operating in West Africa. He was appointed as the group’s deputy leader in 2021, following the death of his predecessor, [Abu Musab al-Barnawi](https://en.wikipedia.org/wiki/Abu_Musab_al-Barnawi). His death represents a major disruption to ISIS’s command structure in Africa, where the group has been expanding its influence in recent years.

The strike comes amid heightened scrutiny of US counterterrorism operations in Africa, particularly after the 2020 [Niger ambush](https://en.wikipedia.org/wiki/2017_Niger_ambush) that killed four US soldiers. The Biden administration has continued to prioritize counterterrorism efforts in the region, though public details about such operations remain limited. The US Africa Command (AFRICOM) has not yet released a statement on the operation, but military analysts note that al-Minuki’s elimination could temporarily weaken ISIS’s operational capacity in the region.

## ISIS leadership decimated in recent years

Al-Minuki’s death follows a series of high-profile strikes against ISIS leadership, including the 2019 killing of [Abu Bakr al-Baghdadi](https://en.wikipedia.org/wiki/Abu_Bakr_al-Baghdadi), the group’s self-proclaimed caliph, in a US raid in Syria. His predecessor, al-Barnawi, was killed in a Nigerian military operation in 2021, further crippling the group’s regional leadership. Despite these losses, ISIS has continued to regroup, particularly in the Lake Chad basin and the Sahel, where it has exploited local grievances and weak governance to expand its reach.
...
- **Source:** [Euronews](http://www.euronews.com/2026/05/16/trump-says-most-active-terrorist-in-the-world-killed-in-us-nigerian-operation)
...
> **[Read the full story on Euronews →](http://www.euronews.com/2026/05/16/trump-says-most-active-terrorist-in-the-world-killed-in-us-nigerian-operation)**
