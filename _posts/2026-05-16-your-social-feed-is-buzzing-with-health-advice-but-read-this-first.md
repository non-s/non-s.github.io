---
layout: post
title: "5 Ways to Vet Social Media Health Advice Before Trying It"
date: 2026-05-16 01:00:23 +0000
categories: [science]
tags: [science, biology, chemistry, your-social-feed, buzzing-with-health, advice, health, social-media-health-advice, how-to-spot-bad-health-advice-online, are-viral-health-trends-safe, doctors-warn-about-social-media-health-tips, verifying-health-information-from-social-media, risks-of-unproven-health-remedies, how-social-media-affects-health-decisions, when-to-ignore-health-advice-on-social-media]
author: "GlobalBR News"
description: "Social media is flooded with health tips, but not all are reliable. Learn how to spot dangerous misinformation and verify advice before changing habits."
source_url: "https://www.sciencealert.com/your-social-feed-is-buzzing-with-health-advice-but-read-this-first"
source_name: "ScienceAlert"
sentiment: "negative"
lang: "en"
image: "https://www.sciencealert.com/images/2026/05/woman-on-phone.jpg"
image_alt: "5 Ways to Vet Social Media Health Advice Before Trying It"
image_caption: "A person scrolling through a social media feed filled with health advice posts on a smartphone."
keywords: ["social media health advice", "how to spot bad health advice online", "are viral health trends safe", "doctors warn about social media health tips", "verifying health information from social media", "risks of unproven health remedies", "how social media affects health decisions", "when to ignore health advice on social media"]
key_points:
  - "Social media health tips often lack scientific validation"
  - "Doctors report rise in patients harmed by unproven remedies"
  - "Experts recommend checking sources before following advice"
faq:
  - q: "What percentage of social media health advice is actually accurate?"
    a: "Research shows only about 14% of viral health videos contain fully accurate information, according to a BMJ study tracking 2,000 posts. Most include exaggerated claims or outdated advice."
  - q: "How can I tell if a health tip on social media is trustworthy?"
    a: "Look for red flags like miraculous cure claims, no expert sources, or pressure to act immediately. Verify by checking with reputable institutions like the WHO or Mayo Clinic before trying any new treatment."
  - q: "What kind of harm has come from social media health trends?"
    a: "Doctors report cases of liver failure from unregulated supplements, malnutrition from extreme diets, and dangerous drug interactions. One documented case involved a teenager hospitalized after a TikTok diet challenge led to acute malnutrition."
  - q: "Why do social media algorithms promote unproven health advice?"
    a: "Platforms prioritize engagement over accuracy, pushing sensational content that gets more views and shares. Fact-checking often happens too late, long after posts have gone viral and spread misinformation widely."
  - q: "What should I do if I’ve already tried a harmful health trend from social media?"
    a: "Contact your doctor immediately to assess potential side effects. Save any relevant posts or links to share with healthcare providers. Early intervention can prevent long-term damage from unproven treatments."
breaking: false
hook: "One viral health post could change your life—will it be for better or worse?"
tl_dr: "Verify social media health advice with trusted sources before trying any new treatment."
lead: "Nearly 70% of Americans have tried health advice from social media, but doctors warn most tips lack scientific backing or pose real risks. Experts explain how to filter fact from fiction."
...
Algorithms on major platforms prioritize engagement over accuracy, pushing sensational content regardless of medical validity. Posts claiming to cure chronic conditions with a single supplement or extreme diet often rack up millions of views before fact-checkers can intervene. A [BMJ study](https://www.bmj.com/) last year tracked 2,000 viral health videos and found only 14% contained fully accurate information. The rest included exaggerated claims, outdated treatments, or outright falsehoods.

## The real risks people face
Emergency rooms have seen a rise in cases linked to social media trends. Doctors report cases of liver failure from unregulated supplements, dangerous drug interactions from self-prescribed herbal remedies, and severe dietary deficiencies caused by viral fasting challenges. One 2022 case involved a teenager hospitalized after attempting a [challenger diet](https://en.wikipedia.org/wiki/Challenger_diet) promoted on TikTok, resulting in acute malnutrition.

## How to spot misinformation in your feed
Experts advise looking for red flags: claims of miraculous cures, before-and-after photos with no medical context, and posts that encourage skipping professional care. Check if the advice cites peer-reviewed research or links to reputable institutions like the [World Health Organization](https://www.who.int/) or [Mayo Clinic](https://www.mayoclinic.org/). Be skeptical of posts that pressure users to act immediately or feature unverified personal stories without expert input.

## What health professionals recommend
Doctors urge patients to discuss any social media health tips with their physicians before trying them. The [American Medical Association](https://www.ama-assn.org/) recently updated its ethics guidelines to include social media health advice as a patient safety issue. Clinicians report growing numbers of patients arriving with side effects from unproven treatments, complicating their care. Patients should also cross-check advice with databases like [Cochrane Reviews](https://www.cochrane.org/) for systematic evidence summaries.

## When platforms finally take action
Social media companies have begun labeling health-related content, but enforcement remains inconsistent. [Meta](https://en.wikipedia.org/wiki/Meta_Platforms) and [TikTok](https://en.wikipedia.org/wiki/TikTok) now partner with fact-checking organizations to review medical claims, but the process lags behind viral spread. Critics argue platforms need stricter pre-screening for health-related content to prevent harm before posts go live. Until then, users bear the responsibility of verifying what they share.
...
- **Source:** [ScienceAlert](https://www.sciencealert.com/your-social-feed-is-buzzing-with-health-advice-but-read-this-first)
...
> **[Read the full story on ScienceAlert →](https://www.sciencealert.com/your-social-feed-is-buzzing-with-health-advice-but-read-this-first)**
