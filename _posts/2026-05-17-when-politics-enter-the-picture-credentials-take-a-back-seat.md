---
layout: post
title: "When politics enter the picture, credentials take a back seat"
date: 2026-05-17 21:00:01 +0000
categories: [science]
tags: [physics, science, research, most-americans, scientific-reports, expert-trust, political-bias-in-expertise, credibility-vs-politics, who-do-americans-trust-as-experts, public-trust-in-science, expert-credentials-debate, how-politics-affects-trust-in-experts, mertcan-gungor-uc-irvine-study, trust-in-expert-knowledge, political-identity-and-credibility]
author: "GlobalBR News"
description: "Americans say credentials matter most in experts — until they learn their politics. New UC Irvine study reveals how political bias trumps degrees and experience"
source_url: "https://phys.org/news/2026-05-politics-picture-credentials-seat.html"
source_name: "Phys.org"
sentiment: "neutral"
lang: "en"
image: "https://scx1.b-cdn.net/csz/news/tmb/2025/expert-1.jpg"
image_alt: "When politics enter the picture, credentials take a back seat"
image_caption: "A person reading a resume while holding a red and blue political sign, symbolizing how political bias can override profe"
keywords: ["expert trust", "political bias in expertise", "credibility vs politics", "who do Americans trust as experts", "public trust in science", "expert credentials debate", "how politics affects trust in experts", "Mertcan Güngör UC Irvine study"]
key_points:
...
faq:
  - q: "What did the UC Irvine study actually test?"
    a: "The study ran three experiments with over 2,400 Americans. Participants were asked to evaluate experts based on bios that included real credentials but varied political cues. The goal was to see whether stated preferences for credentials matched actual trust when politics entered the picture."
  - q: "Did the study find that political bias overrides all expertise?"
    a: "Not all expertise — but it showed that when people learn an expert’s political views, their trust in that person’s knowledge drops sharply, even if the credentials stay the same. This effect held across diverse topics like skincare, nutrition, and social issues."
  - q: "Did the researchers use real experts or just fictional bios?"
    a: "The study used fictional expert bios with realistic credentials: Ph.D.s, published research, awards. The bios were identical except for the political affiliation or views added at the end. This allowed the researchers to isolate the effect of politics on trust."
  - q: "Does this mean Americans don’t actually value credentials?"
    a: "No — the first experiment showed that Americans do say they value credentials like degrees and peer recognition. But the second experiment found that when politics are introduced, people ignore those same credentials and make judgments based on political alignment instead."
  - q: "What does this mean for public trust in science and experts?"
    a: "It suggests that political identity is now a stronger filter for trust than professional qualifications. When people dismiss experts based on politics, it weakens the role of evidence in public discourse and can erode trust in institutions, science, and shared reality."
breaking: false
hook: "Your favorite expert just got a Ph.D. from Harvard — and now you don’t care."
tl_dr: "New UC Irvine study finds most Americans ignore expert credentials when politics enter the picture."
lead: "Most Americans say they trust experts based on degrees and experience — but a new UC Irvine study shows that all bets are off once they learn those experts’ politics. The findings, published in Scientific Reports, suggest political bias often overrides real qualifications in public judgment."
content_type: "news"
entities:
  - "Mertcan Güngör"
...
Güngör and his co-authors, Nathan Ballantyne and Jared B. Celniker from [Arizona State University](https://en.wikipedia.org/wiki/Arizona_State_University), say the next step is to test whether these biases change when people are directly confronted with the contradiction: showing them that their trust decisions don’t match their stated values.
...
- **Source:** [Phys.org](https://phys.org/news/2026-05-politics-picture-credentials-seat.html)
...
> **[Read the full story on Phys.org →](https://phys.org/news/2026-05-politics-picture-credentials-seat.html)**
...
- [NASA tests Mars helicopter blades that break the sound barrier](/science/2026/05/17/watch-nasas-new-mars-helicopter-rotor-break-the-speed-of-sound-video/)
- [Live stream asteroid the size of a blue whale passing Earth May 18](/science/2026/05/17/watch-an-asteroid-the-size-of-a-blue-whale-hurtle-towards-earth-live-online-may/)
