...
def test_main_prints_one_result_list_per_query(monkeypatch, capsys):
    ...
    assert hit["photographer"] == "someartist"
    assert hit["photographer_url"] == "https://pixabay.com/users/someartist-1/"
...
def test_main_flags_hits_that_dont_match_the_anime_style_signals(monkeypatch, capsys):
    clip = BrollClip(
        ...
        height=1080,
        duration_s=8.0,
        source_metadata={"pixabay_video_id": "456", "tags": "man, books, library"},
    )
