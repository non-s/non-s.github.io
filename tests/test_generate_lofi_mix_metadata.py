...
def test_build_metadata_series_is_named_per_mood_bucket_and_format(tmp_path):
    ...
    meta = lofi_mix._build_metadata("Rain Window", {}, [], 3600.0, video_path, slug="lofi-1700000000-1234")
...
def test_build_metadata_series_differs_from_the_shorts_suffix(tmp_path):
    ...
    meta = lofi_mix._build_metadata("Cat Sleeping", {}, [], 3600.0, video_path, slug="lofi-1700000000-5678")
