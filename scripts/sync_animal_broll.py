...
from utils.broll import BrollClip, download_clip, fetch_pixabay, looks_animal_relevant  # noqa: E402
...
def _looks_animal_relevant(clip: BrollClip) -> bool:
    return looks_animal_relevant(str(clip.source_metadata.get("tags") or ""))
...
def main() -> int:
    ...
    queries = random.sample(ANIMAL_QUERIES, k=min(3, len(ANIMAL_QUERIES)))
