...
def generate_assets():
    ...
    commands = [
        ...
        [
            ...
            "lavfi",
            "-i",
            "anoisesrc=c=brown:r=44100:a=0.8",
            "-af",
            "lowpass=f=150, volume=0.6",
            "-t",
            "60",
        ...
        [
            ...
            "synth=60:0:sine:65",
            "-af",
            "vibrato=f=0.3:d=0.8, volume=0.4",
            "-t",
            "60",
        ...
        [
            ...
            "-af",
            "bandpass=f=400:width_type=q:w=0.5, volume=0.5",
            "-t",
            "60",
        ...
        [
            ...
            "lavfi",
            "-i",
            "anoisesrc=c=white:r=44100:a=1",
            "-af",
            "bandpass=f=800:width_type=h:w=500, afade=t=in:ss=0:d=0.1, afade=t=out:ss=0.1:d=0.6, volume=1.0",
            "-t",
            "0.7",
        ...
        [
            ...
            "synth=1:0:sine:40",
            "-af",
            "afade=t=out:ss=0:d=1, volume=1.5",
            "-t",
            "1",
