...
WORKFLOW_TOKENS = {
    ...
    ".github/workflows/youtube-bot.yml": (
        ...
        "scripts/queue_ready_count.py --refresh --json",
        "publish_eligible",
        "count_field pending",
        ...
        'while [ "${publishable}" -lt "${minimum_to_publish}" ]',
        "Publish-eligible inventory can satisfy this one-Short run",
        "at least one Short clears final publish quality",
