...
WORKFLOW_TOKENS = {
    ...
    ".github/workflows/youtube-bot.yml": (
        ...
        'target="${QUEUE_TARGET_PUBLISH_READY:-24}"',
        "PUBLISH_BACKFILL_READY_TARGET || vars.PUBLISH_BACKFILL_QUEUE_TARGET || '24'",
        "QUEUE_TARGET_PENDING: ${{ vars.PUBLISH_BACKFILL_QUEUE_TARGET || '24' }}",
        "QUEUE_BACKFILL_PENDING_BATCH: ${{ vars.PUBLISH_BACKFILL_PENDING_BATCH || '12' }}",
